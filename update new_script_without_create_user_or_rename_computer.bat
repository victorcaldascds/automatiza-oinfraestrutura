...
PAUSE
echo Ja finalizamos as instalacoes Dell Support Assist, seria interessante reiniciar a maquina e executar o windows update!!!
pause
exit
:notebook2
cls
bitsadmin /transfer LenovoSupportAssist /priority normal https://download.lenovo.com/pccbbs/thinkvantage_en/system_update_5.07.0139.exe "C:\Users\%username%\Downloads\system_update_5.07.0139.exe" 
PAUSE
echo Aperte para instalar
start C:\Users\"%username%"\Downloads\system_update_5.07.0139.exe
PAUSE
echo Ja finalizamos as instalacoes do Lenovo Support Assist, seria interessante reiniciar a maquina e executar o windows update!!!
pause
exit
